---
name: architect
description: Software architecture specialist for system design, scalability, and technical
...
1. **Hybrid Deployment**: Vercel (frontend) + Cloud Run (backend) for optimal
   performance
