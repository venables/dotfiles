...
**File/Component:** [path/to/file.ts] **Reviewed:** YYYY-MM-DD **Reviewer:**
...
**Severity:** CRITICAL **Category:** SQL Injection / XSS / Authentication / etc.
...
**Remember**: Security is not optional, especially for platforms handling real
money. One vulnerability can cost users real financial losses. Be thorough, be
